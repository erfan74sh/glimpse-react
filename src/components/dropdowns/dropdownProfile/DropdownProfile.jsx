...
const DropdownProfile = ({ showDropdown }) => {
	return (
		<ul
			...
			} absolute flex flex-col px-3 text-lg text-gray-500 font-normal bg-white shadow-full-sm top-full right-0 w-max capitalize rounded-md transform translate-y-9 overflow-hidden z-10 transition-all`}
		>
			<li>
