		...
		const data = [
			{
				...
				showDropdown: false,
				data: [
					{ name: "floor level", uv: 400, amt: 8 },
					{ name: "X- Dimention", uv: 400, amt: 8 },
					{ name: "Y- Dimention", uv: 450, amt: 20 },
					{ name: "rotation angle", uv: 450, amt: 20 },
					{ name: "WWR south", uv: 450, amt: 20 },
					{ name: "WWR north", uv: 450, amt: 20 },
					{ name: "south Shading type", uv: 410, amt: 20 },
					{ name: "boundry condition east wall", uv: 410, amt: 20 },
					{ name: "boundry condition west wall", uv: 410, amt: 20 },
					{ name: "boundry condition north wall", uv: 410, amt: 20 },
					{ name: "boundry condition south wall", uv: 410, amt: 20 },
					{ name: "boundry condition roof", uv: 410, amt: 20 },
					{ name: "boundry condition floor", uv: 410, amt: 20 },
					{ name: "wall u-value", uv: 380, amt: 30 },
					{ name: "roof u-value", uv: 380, amt: 30 },
					{ name: "floor u-value", uv: 380, amt: 30 },
					{ name: "window u-value", uv: 380, amt: 30 },
					{ name: "south neighbor distance", uv: 380, amt: 30 },
					{ name: "south neighbor height", uv: 380, amt: 30 },
					{ name: "north neighbor distance", uv: 380, amt: 30 },
					{ name: "north neighbor height", uv: 380, amt: 30 },
					{ name: "HVAC", uv: 380, amt: 30 },
					{ name: "natural ventilation", uv: 380, amt: 30 },
